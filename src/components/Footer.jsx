...
const Footer = () => {
  return (
    <div
      className="animateHidden opacity-0 flex flex-col justify-center items-center max-w-[1240px] md:max-w-full bg-[#02021b] h-screen transition-all ease-in-out duration-[2000ms]"
      id="contacts"
    >
