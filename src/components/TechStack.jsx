  ...
  return (
    <div className="flex flex-col gap-3 px-8">
      ...
      <ul className="my-3 list-disc ml-3">
        <li className="text-[#8892b0] md:text-base lg:text-lg my-2">HTML5</li>
        ...
        <li className="text-[#8892b0] md:text-base lg:text-lg my-2">NodeJS</li>
        <li className="text-[#8892b0] md:text-base lg:text-lg my-2">
          ExpressJS
        </li>
        <li className="text-[#8892b0] md:text-base lg:text-lg my-2">MySql</li>
      </ul>
    </div>
  );
};
