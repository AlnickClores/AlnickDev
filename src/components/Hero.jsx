    ...
    <div>
      ...
      >
        <div className="flex flex-col items-center md:gap-5 p-5">
          <h1 className="text-[40px] tracking-tight md:text-5xl lg:text-7xl font-bold">
            Alnick Clores
          </h1>

          <h1 className="text-[30px] tracking-tight md:text-5xl lg:text-7xl font-bold text-[#8892b0]">
            Frontend Engineer
          </h1>
        ...
        <div className="flex justify-center">
          <button
            className="border border-[#45adff] rounded py-2 px-12 text-sm cursor-pointer md:py-3 lg:px-20 lg:text-xl bg-transparent hover:bg-[#45adff]/20 transition-all ease-in-out duration-500"
            onClick={myResume}
          >
